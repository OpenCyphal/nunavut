...
Any option marked "YES" for Req[uir]ed must be provided with a valid value when configuring.

+-------------------------------------------+--------+--------+------------------------------+----------------------------------------+
| Option                                    | Type   | Req'ed | Values                       | Description                            |
+===========================================+========+========+==============================+========================================+
| NUNAVUT_VERIFICATION_LANG                 | string |  YES   | c, cpp                       | Specifies the language for source      |
|                                           |        |        |                              | code generated by nnvg.                |
+-------------------------------------------+--------+--------+------------------------------+----------------------------------------+
| NUNAVUT_VERIFICATION_TARGET_ENDIANNESS    | string |   NO   | little, big, any             |                                        |
+-------------------------------------------+--------+--------+------------------------------+----------------------------------------+
| NUNAVUT_VERIFICATION_TARGET_PLATFORM      | string |   NO   | x86, amd64                   |                                        |
+-------------------------------------------+--------+--------+------------------------------+----------------------------------------+
| NUNAVUT_VERIFICATION_OPTIMIZATION_LEVEL   | string |   NO   | debug, release, min-size     |                                        |
+-------------------------------------------+--------+--------+------------------------------+----------------------------------------+
| NUNAVUT_VERIFICATION_SER_ASSERT           | bool   |   NO   | ON, OFF                      |                                        |
+-------------------------------------------+--------+--------+------------------------------+----------------------------------------+
| NUNAVUT_VERIFICATION_SER_FP               | bool   |   NO   | ON, OFF                      |                                        |
+-------------------------------------------+--------+--------+------------------------------+----------------------------------------+
