...
def expand_service_types(
    models: Iterable[pydsdl.CompositeType], keep_services: bool = False
) -> Iterator[pydsdl.CompositeType]:
    """
...
def make_random_object(model: pydsdl.SerializableType) -> Any:
    """
...
def are_close(model: pydsdl.SerializableType, a: Any, b: Any) -> bool:
    """
