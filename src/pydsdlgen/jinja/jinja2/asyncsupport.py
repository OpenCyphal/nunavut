...
from pydsdlgen.jinja.jinja2.utils import concat, internalcode, Markup
from pydsdlgen.jinja.jinja2.environment import TemplateModule
from pydsdlgen.jinja.jinja2.runtime import LoopContextBase, _last_iteration
...
def patch_template():
    from pydsdlgen.jinja.jinja2 import Template
...
def patch_runtime():
    from pydsdlgen.jinja.jinja2.runtime import BlockReference, Macro
...
def patch_filters():
    from pydsdlgen.jinja.jinja2.filters import FILTERS
    from pydsdlgen.jinja.jinja2.asyncfilters import ASYNC_FILTERS
