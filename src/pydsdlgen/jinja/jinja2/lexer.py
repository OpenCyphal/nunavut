...
from pydsdlgen.jinja.jinja2._compat import implements_iterator, intern, iteritems, text_type
from pydsdlgen.jinja.jinja2.exceptions import TemplateSyntaxError
from pydsdlgen.jinja.jinja2.utils import LRUCache
...
try:
    ...
    from pydsdlgen.jinja.jinja2 import _identifier
