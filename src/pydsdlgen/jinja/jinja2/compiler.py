...
from pydsdlgen.jinja.jinja2.visitor import NodeVisitor
from pydsdlgen.jinja.jinja2.optimizer import Optimizer
from pydsdlgen.jinja.jinja2.exceptions import TemplateAssertionError
from pydsdlgen.jinja.jinja2.utils import Markup, concat, escape
from pydsdlgen.jinja.jinja2._compat import range_type, text_type, string_types, \
     iteritems, NativeStringIO, imap, izip
from pydsdlgen.jinja.jinja2.idtracking import Symbols, VAR_LOAD_PARAMETER, \
...
class CodeGenerator(NodeVisitor):
    ...
    def visit_Template(self, node, frame=None):
        ...
        from pydsdlgen.jinja.jinja2.runtime import __all__ as exported
        self.writeline('from __future__ import %s' % ', '.join(code_features))
        self.writeline('from pydsdlgen.jinja.jinja2.runtime import ' + ', '.join(exported))

        if self.environment.is_async:
            self.writeline('from pydsdlgen.jinja.jinja2.asyncsupport import auto_await, '
