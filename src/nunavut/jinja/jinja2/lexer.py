...
from nunavut.jinja.jinja2._compat import implements_iterator, intern, iteritems, text_type
from nunavut.jinja.jinja2.exceptions import TemplateSyntaxError
from nunavut.jinja.jinja2.utils import LRUCache
...
try:
    ...
    from nunavut.jinja.jinja2 import _identifier
    name_re = re.compile(r'[\w{0}]+'.format(_identifier.pattern))
    check_ident = True
    # remove the pattern from memory after building the regex
    import sys
    del sys.modules['nunavut.jinja.jinja2._identifier']
    from nunavut.jinja import jinja2 as jinja2_i
